package com.evilgeniuses.lifecare.fragments.authentication;
...
import com.evilgeniuses.lifecare.activities.NavigationDoctorActivity;
...
public class RegistrationFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final String[] items = {"Категория пользователя", "Сиделка / родственник", "Врач"};
    ...
    public void Login() {
        ...
        switch (UserCategories){
            case "Врач":
                intent = new Intent(getActivity(), NavigationDoctorActivity.class);
                break;
            default:
                intent = new Intent(getActivity(), NavigationNurseActivity.class);
                break;
        }
